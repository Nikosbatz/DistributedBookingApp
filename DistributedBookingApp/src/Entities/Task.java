...
public class Task implements Serializable {
    ...
    public void setDateFirst(String dateFirst) throws ParseException, java.text.ParseException {
    ...
    public void setDateLast(String dateLast) throws ParseException, java.text.ParseException {
